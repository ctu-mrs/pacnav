...
input=(
  'swarm_controller' 'waitForControl; roslaunch swarm_control_manager swarm_control_manager.launch controller_pkg:=boids origin_frame:=local_origin uav_frame:=fcu_untilted
'
...
'
  'shared_gps_aggr' 'waitForControl; roslaunch swarm_utils shared_gps_aggr.launch origin_frame:=gps_origin gps_topic_name:=slow_odom
'
'ros_bridge' 'waitForRos; roslaunch rosbridge_server rosbridge_websocket.launch
'
